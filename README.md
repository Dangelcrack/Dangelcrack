Soy desarrollador con titulación en DAM, ASIR y Especialización en Python, especializado en backend Java/Python y aplicaciones multiplataforma. Busco mi primera oportunidad laboral en un equipo donde seguir creciendo.

<h1> ¡Hola, Compañeros < Coders/ >! <img src="https://raw.githubusercontent.com/MartinHeinz/MartinHeinz/master/wave.gif" width="40px"> </h1>
 ...
 * @param {string} Titulos - Técnico Superior en DAM y ASIR + Especialización en Python.
 * @param {string} Especializacion - Backend Java/Python, aplicaciones multiplataforma y bases de datos.
 ...
 * @param {string} Educacion - IES Francisco de los Ríos, Córdoba.
...
<div>
  <p style="display: inline-block;" align="center">
    ...
    <kbd>
      ...
      <br>
      <br>
      <img width="30px" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg" alt="spring" title="Spring Boot"/>
...
Si tienes alguna pregunta sobre desarrollo backend, aplicaciones multiplataforma o bases de datos, no dudes en <a href="mailto:angelguerrero540@gmail.com">contactarme por correo electrónico</a>. ¡Estaré encantado de ayudarte!
...
<blockquote>"El aprendizaje continuo es la mínima exigencia para el éxito en cualquier campo."
<br><strong>– Brian Tracy</strong></blockquote>
